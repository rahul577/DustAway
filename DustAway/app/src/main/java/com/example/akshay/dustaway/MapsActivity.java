...
public class MapsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLatLngList.add(new LatLng(30.9644845, 76.4874576));

        mLatLngList.add(new LatLng(30.9644845, 76.488458));

        mLatLngList.add(new LatLng(30.9644845, 76.489456));

        mLatLngList.add(new LatLng(30.9645845, 76.4864576));
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) {
                    ...
                    */
                    ...
                    Toast.makeText(MapsActivity.this, "something" + "latitude:" + String.valueOf(location.getLatitude()) + "Longitude" + String.valueOf(location.getLongitude()),Toast.LENGTH_SHORT).show();
